...
export const initialProduct: Product = {
  ...
  price: "$895",
  image_url: "http://localhost:3001/images/image1.png",
...
export const imageOptions = [
  { value: "http://localhost:3001/images/image1.png", label: "Product Image 1" },
  { value: "http://localhost:3001/images/image2.png", label: "Product Image 2" },
  { value: "http://localhost:3001/images/image3.png", label: "Product Image 3" },
  { value: "http://localhost:3001/images/image4.png", label: "Product Image 4" },
];